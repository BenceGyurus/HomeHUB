...
const translations = {
  hu: {
    ...
    no_apps_for_role: 'Nincs hozzárendelt alkalmazás a jogosultsági csoportjaidhoz.',
    auth_required: 'Hozzáférés Zárolva • Bejelentkezés Szükséges',
    auth_required_desc: 'A homelab szolgáltatások és alkalmazások eléréséhez kérlek jelentkezz be az Authentik SSO azonosítóddal vagy a lokális fiókoddal.',
  ...
  en: {
    ...
    no_apps_for_role: 'No applications assigned to your role/groups.',
    auth_required: 'Access Locked • Authentication Required',
    auth_required_desc: 'Please sign in with your Authentik SSO or local account to view and access homelab services.',
    settings: 'Settings',
    save: 'Save Changes',
    apps: 'Applications',
